#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Aggregate v2 (6asin + display-position) into full summary matching old structure."""
import json, glob
...
PRODUCT_META = {
    "A": {"brand": "AmazerBath", "price": 18.99, "rating": 4.5, "reviews": 4156, "avail": "配送受限/无Featured Offer"},
    "B": {"brand": "jssablo", "price": 7.19, "rating": 4.4, "reviews": 1872, "avail": "现货"},
    "C": {"brand": "LQFMEHOT", "price": 7.09, "rating": 4.6, "reviews": 974, "avail": "现货"},
    "D": {"brand": "Laumyasof", "price": 9.99, "rating": 4.4, "reviews": 16, "avail": "新品"},
    "E": {"brand": "Dependable", "price": 9.99, "rating": 4.3, "reviews": 116, "avail": "仅剩10件"},
    "F": {"brand": "MuuXii", "price": None, "rating": 4.4, "reviews": 10, "avail": "缺货"},
}
...
def main():
    ...
    summary = {
        "meta": {"survey_a": {"id":"shower_liner_6asin_v2","n":n,"job":"survey-shower-liner-6asin-v2-n1000"},
