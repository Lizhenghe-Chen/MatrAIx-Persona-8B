#!/usr/bin/env python3
"""Generate the 6-ASIN shower liner v2 job YAML (adds display-position-influence question)."""
...
def main() -> None:
    ...
    task = "application/tasks/survey_shower-liner-6asin-v3"
    slug = f"survey-shower-liner-6asin-v3-n{sample_size}"
    sys.argv = [
        "generate_shower_liner_v2_jobs",
    ...
    gen.main()
    print(f"[generated] {slug} (task={task})")
