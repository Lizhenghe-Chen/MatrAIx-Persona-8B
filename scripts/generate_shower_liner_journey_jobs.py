#!/usr/bin/env python3
"""Generate the 6-ASIN shower liner survey job YAML via OFFICIAL Playground services
(amazon-only personas, North America region, fixed seed 42)."""
...
def main() -> None:
    ...
    task = "application/tasks/survey_shower-liner-6asin-journey"
    slug = f"survey-shower-liner-journey-n{sample_size}"
    sys.argv = [
        "generate_shower_liner_jobs",
